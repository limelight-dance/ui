      ...
      <div className="about">
        ...
        <div className="multi-column">
          <div className="column">
            <h1>Tutorials</h1>
            <p>We hold free weekly dance tutorials at the University of Waterloo. These tutorials are open to the public. You can find more information on <a href="https://www.facebook.com/limelightdancecrew/">Facebook</a>.</p>
          </div>
          <div className="column">
            <h1>Covers</h1>
            <p>We create Kpop dance cover videos and post them on <a href="https://www.youtube.com/channel/UC40GdqVnIsD23o_5fYvy3dQ">YouTube</a>. We hold auditions the select the best candidates for our covers.</p>
          </div>
          <div className="column">
            <h1>Performances</h1>
            <p>We perform at various events and showcases. For performance inquiries, please email us at <a href="mailto:limelightmvcc@gmail.com">limelightmvcc@gmail.com</a>.</p>
          </div>
        </div>
      </div>
    )
